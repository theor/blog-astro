...
export class Roads {
    ...
    * @param {number} dir_y
    */
    update(b, time, dir_x, dir_y) {
        var ptr0 = passArray32ToWasm0(b, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        wasm.roads_update(this.__wbg_ptr, ptr0, len0, addHeapObject(b), time, dir_x, dir_y);
    }
}
/**
*/
export class Roads2 {
    ...
    * @param {number} dir_y
    */
    update(ctx, time, dir_x, dir_y) {
        try {
            wasm.roads2_update(this.__wbg_ptr, addBorrowedObject(ctx), time, dir_x, dir_y);
        } finally {
