...
*/
export function halton_demo(step, x) {
    var ptr0 = passArrayF64ToWasm0(x, wasm.__wbindgen_malloc);
    var len0 = WASM_VECTOR_LEN;
    wasm.halton_demo(step, ptr0, len0, addHeapObject(x));
}
...
* @param {number} h
*/
export function render(t, b, fire, w, h) {
    var ptr0 = passArray8ToWasm0(b, wasm.__wbindgen_malloc);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = passArray8ToWasm0(fire, wasm.__wbindgen_malloc);
    var len1 = WASM_VECTOR_LEN;
    wasm.render(t, ptr0, len0, addHeapObject(b), ptr1, len1, addHeapObject(fire), w, h);
}
...
* @returns {Element}
*/
export function make_fragment(x, t) {
    const ret = wasm.make_fragment(x, t);
