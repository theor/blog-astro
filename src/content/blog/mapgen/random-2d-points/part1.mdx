...
banner: "images/HaltonColors.png"
serie_part: 2
toc: true
---
...
![Unity.Mathematics.Random](./images/1-Points-Rnd.png)
...
![Halton sequence, bases 7/11](./images/Halton7-11.png)

Now, just to show why you should be careful when picking bases for Halton:
![Halton with identical bases 3/3](./images/Halton3-3.png)
![Halton with divisible bases 4/24](./images/Halton4-24.png)
...
![1000 points colored with the Halton sequence](./images/HaltonColors.png)
