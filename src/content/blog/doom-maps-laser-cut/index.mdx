...
<div class="gallery">
<Figure caption="base = 11 , f = 1" src="./halton-11.svg" />
<Figure caption="base = 17 , f = 1" src="./halton-17.svg" />
<Figure caption="base = 23 , f = 1" src="./halton-23.svg" />
<Figure caption="base = 11 , f = 1.5" src="./halton-1_5-11.svg" />
<Figure caption="base = 17 , f = 1.5" src="./halton-1_5-17.svg" />
<Figure caption="base = 23 , f = 1.5" src="./halton-1_5-23.svg" />
</div>
...
<img loading="lazy" src="./case1.webp" alt="Case 1, a simple polygon" width="30%"/>
...
<img loading="lazy" src="./case2.webp" alt="Case 1, a simple polygon" width="30%"/>
...
<img loading="lazy" src="./case3.webp" alt="Case 1, a simple polygon" width="30%"/>
